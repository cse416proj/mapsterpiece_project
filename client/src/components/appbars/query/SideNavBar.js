    ...
    >
      <Menu>
        ...
        <SubMenu onClick={handleSelectAllMaps} label="All Maps"  id="AllMaps">
          <MenuItem onClick={(e) => handleSelectView(e, "PIN_MAPS")}  id="PIN_MAPS"> Pin Map </MenuItem>
        ...
        <SubMenu onClick={handleSelectAllPosts} label="All Posts" id="AllPosts">
          <MenuItem onClick={(e) => handleSelectView(e, "PIN_POSTS")} id="PIN_POSTS"> Pin Map </MenuItem>
